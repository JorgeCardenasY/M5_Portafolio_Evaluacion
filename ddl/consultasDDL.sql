...
-- modificar correos electronico para que sea not null
ALTER TABLE clientes MODIFY email VARCHAR(50) NOT NULL;

-- Eliminar tabla pedidos con metodo cascada
/* 
-- DROP TABLE PRODUCTOS CASCADE;
DROP TABLE IF EXISTS PRODUCTOS CASCADE;

Pero, si bien sigo lo mencionado en el enlace: 
https://dev.mysql.com/doc/refman/8.4/en/drop-table.html

no se efectúa el dropeo de la tabla productos.  */

-- Eliminar columna correo electronico de la tabla clientes:
ALTER TABLE Clientes DROP COLUMN email;

-- 📥 Trunca la TABLA PEDIDOS:
